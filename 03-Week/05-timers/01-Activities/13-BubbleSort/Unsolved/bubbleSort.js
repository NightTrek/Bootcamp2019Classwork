...
var bubbleSortArray = function (array) {
  let swap = true;
  ...
  while (swap) {
    ...
    for (let left = 0; left < array.length; left++) {
      ...
      if (array[left] > array[left + 1]) {
        ...
        console.log(`swapping ${array[left]} with ${array[left + 1]}`)
        let temp = array[left];
...
//pops the last element and loops through the array 
var insertionSortArray = function (array) {
  array
